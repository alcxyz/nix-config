...
in
{
  ...
  config = mkIf config.programs.foot.enable { # Use the built-in enable option
    ...
    # Configure colors and other settings using the programs.foot.settings option,
    # providing the content of the foot.ini file as a string.
    programs.foot.settings = ''
      ...
      # using the foot.ini syntax within this multiline string.
      # For example:
      # term=foot
