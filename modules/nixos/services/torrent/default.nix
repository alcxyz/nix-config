...
in {
  ...
  config = lib.mkIf config.services.torrent.enable {
    ...
    systemd.mounts = [
      {
        description = "Bind mount /zpool/stash to ${stashOverlayDir} with remapped ownership";
        what = stashDir;
      ...
      {
        description = "Bind mount /zpool/media to ${mediaOverlayDir} with remapped ownership";
        what = mediaDir;
      ...
      {
        description = "Bind mount /ypool/stash to ${stash2OverlayDir} with remapped ownership";
        what = stash2Dir;
