...
| [ADR-0045](0045-xev-and-xps-kubernetes-node-onboarding.md) | xev and xps Kubernetes node onboarding | Accepted, xev onboarded with native runner; xps workstation-only | xev, xps, k3s, Longhorn, Forgejo |
